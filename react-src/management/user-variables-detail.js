...
export default class UserVariablesDetail extends React.Component {
    ...
    changeName() {
        ...
        Axios.post(app.urlPrefix + 'api/userVariables/rename/' + this.props.name + '?name=' + this.state.varName)
            .then(res => {
    ...
    remove() {
        ...
        Axios.post(app.urlPrefix + 'api/userVariables/remove/' + this.props.name)
            .then(res => {
