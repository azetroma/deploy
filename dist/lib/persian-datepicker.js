            ...
            if (this.model.options.monthPicker.enabled) {
                ...
                $(document).on('click', '#' + that.model.view.id + ' .datepicker-month-view .month-item:not(.month-item-disable)', function () {
                    ...
                    if (!that.model.options.onlySelectOnDate) {
                        /*در صورتی که تاریخ حال یکی از ماه‌های نیمه اول باشد پیش فرض روز برابر ۳۱ است 
                         که در صورتی که  نیمه دوم انتخاب شود چون ۳۱ روز نیست روز اول ماه بعد انتخاب می‌شود واین باگ است*/
                        that.model.state.setSelectedDateTime('date', 29);
